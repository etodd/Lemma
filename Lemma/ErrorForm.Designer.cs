namespace Lemma
{
	partial class ErrorForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Please copy this crash dump:";
			// 
			// textBox1
			// 
			...
			this.label3.Text = "And leave a comment on the development blog with the crash dump:";
			// 
			// linkLabel1
			// 
			...
			this.linkLabel1.Text = "et1337.wordpress.com";
			this.linkLabel1.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.linkLabel1_LinkClicked);
			// 
			// label4
			// 
			this.label4.AutoSize = true;
			this.label4.Location = new System.Drawing.Point(108, 239);
