namespace Lemma
{
	partial class AnalyticsForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "A recording of your play session was saved to your hard drive. If you want to hel" +
    "p improve the game, please hit \"Submit\" to upload it.";
			// 
			// button1
			// 
			...
			this.label3.Text = "The following information is recorded:";
			// 
			// label4
			// 
			...
			this.label5.Text = "- Timeline of your position coordinates in each level";
			// 
			// label6
			// 
